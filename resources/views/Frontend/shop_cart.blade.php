  ...
  <main>
    ...
    <section class="shop-checkout container">
      ...
      <div class="checkout-steps">
        <a href="{{assert('/cart')}}" class="checkout-steps__item active">
        ...
        <a href="{{asset('/checkout')}}" class="checkout-steps__item">
        ...
        <a href="{{asset('/orderComplete')}}" class="checkout-steps__item">
